      ...
      <View style={styles.stepIndicator}>
        {[1, 2, 3].map((item) => (
          <View key={item} style={styles.stepRow}>
            <View
              style={[styles.stepDot, step >= item && styles.activeStepDot]}
            >
              {step > item && (
                <Ionicons name="checkmark" size={12} color="#fff" />
              )}
              {step === item && <Text style={styles.stepNumber}>{item}</Text>}
            </View>
            {item < 3 && (
              <View
                style={[styles.stepLine, step > item && styles.activeStepLine]}
              />
            )}
          </View>
        ))}
                ...
                <View style={styles.card}>
                  ...
                  {step === 1 && (
                    <View style={styles.stepContainer}>
                      ...
                      />
                      {sendOtpApiError && (
                        <Text style={styles.errorText}>{sendOtpApiError}</Text>
                      )}
                      <Button
